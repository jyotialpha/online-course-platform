...
const About = () => {
  return (
    <>
      <Helmet>
        <title>MockVed - Online Courses & Mock Tests</title>
        <meta name="description" content="MockVed offers online courses, mock tests, and learning resources for all classes." />
      </Helmet>
