...
const Privacy = () => {
  return (
    <>
      <Helmet>
        <title>MockVed Privacy Policy</title>
        <meta name="description" content="MockVed privacy policy explaining how we collect, use, and protect your personal information." />
      </Helmet>
      <div className="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-md my-10">
        <h1 className="text-3xl font-bold mb-6">MockVed Privacy Policy</h1>
        <p className="mb-4">
