...
const CancellationRefund = () => {
  return (
    <>
      <Helmet>
        <title>MockVed Cancellation & Refund Policy</title>
        <meta name="description" content="Learn about MockVed's cancellation and refund policy for online courses and services." />
      </Helmet>
      <div className="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-md my-10">
        <h1 className="text-3xl font-bold mb-6">MockVed Cancellation & Refund Policy</h1>
        <p className="mb-4">
